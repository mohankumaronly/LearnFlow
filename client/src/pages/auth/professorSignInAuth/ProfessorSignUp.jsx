...
const ProfessorSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Redirect to professor verification or dashboard
          ...
          >
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 px-8 py-6 text-white">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-2xl font-bold">Create Professor Account</h2>
              </div>
              <p className="text-purple-100 text-sm">Join our community of educators</p>
            </div>
