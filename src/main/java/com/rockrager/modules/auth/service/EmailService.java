...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String token) {
        ...
        try {
            String subject = "Verify Your Email - RockRager LearnFlowApplication";
            ...
            String body = String.format("""
                ...
                Thank you for registering with RockRager LearnFlowApplication!
    ...
    public void sendPasswordResetEmail(String to, String token) {
        ...
        try {
            String subject = "Reset Your Password - RockRager LearnFlowApplication";
    ...
    private void sendEmail(String to, String subject, String body) {
        ...
        try {
            ...
            if (errorMsg != null) {
                if (errorMsg.contains("LearnFlowApplication")) {
